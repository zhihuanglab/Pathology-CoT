...
def initialize_client(api_server: str):
    ...
    if api_server == 'oai':
        OPENAI_API_KEY="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"
        return openai.OpenAI(
            api_key=OPENAI_API_KEY,
            base_url="https://api.openai.com/v1"
        )
    elif api_server == 'sbb':
        OPENAI_API_KEY = "sk-Liazegu1UIRGErTuc0kkshTzbdqTetjYDpyShOGuFbOE9chu"
        return openai.OpenAI(
            api_key=OPENAI_API_KEY,
            base_url="https://api.shubiaobiao.com/v1"
        )
    elif api_server == 'xai':
        OPENAI_API_KEY = "xai-3DpX8ulAtnRvBKUL4W4ZonBx0E5bU6Oek8QOiyj7MmqNcwIAzYn9VZbOnSqCgU2jBXTKPtMLz0FF75gX"
        return openai.OpenAI(
            api_key=OPENAI_API_KEY,
            base_url="https://api.x.ai/v1"
        )
    elif api_server == 'gemini':
        OPENAI_API_KEY = "AIzaSyBPkg5-44R590I4S2HSlNOf1gYotyGW8T0"
        return openai.OpenAI(
            api_key=OPENAI_API_KEY,
            base_url="https://generativelanguage.googleapis.com/v1beta/openai/"
        )
    elif api_server == 'openrouter':
        OPENAI_API_KEY = "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"
        return openai.OpenAI(
            api_key=OPENAI_API_KEY,
